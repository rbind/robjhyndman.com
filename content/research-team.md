...
<ul>
  <li><b>Potential PhD students:</b> please read <a href="/hyndsight/phdapplicants/"><i>Advice to PhD Applicants</i></a>.</li>
  <li><b>Potential research fellows:</b> All available positions are filled.</li>
</ul>
</blockquote>
...
## PhD students
  ...
  1. **[Earo Wang](http://earo.me)**, *Tidy tools for supporting fluent workflow in temporal data analysis* (PhD, begun 2016). [<i class="fa fa-github-alt" style="color:#03396c;font-size:80%;padding-top:6px;"></i>](https://github.com/earowang)
