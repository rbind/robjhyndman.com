...
The model was first described in  [Hyndman and Fan (2010)](http://robjhyndman.com/papers/peak-electricity-demand/). We are continually improving it, and the latest version is decribed in the [model documentation](http://robjhyndman.com/working-papers/mefm/) which will be updated from time to time.
