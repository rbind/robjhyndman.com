...
mathjax: true
link: http://robjhyndman.com/hyndsight/gefcom2014/
slug: gefcom2014
...
The [2012 GEFcom competition](http://robjhyndman.com/hyndsight/gefcom2012/) was a great success with several new innovative forecasting methods introduced. These have been published in the IJF as follows:<!-- more -->
...
The developers of the best performing methods in the competition will be invited to submit a paper to a [special issue of the IJF on probabilistic energy forecasting](http://robjhyndman.com/hyndsight/probabilistic-energy-forecasting/), to be edited by Tao Hong and Pierre Pinson.
