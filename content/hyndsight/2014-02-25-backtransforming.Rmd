...
mathjax: true
link: http://robjhyndman.com/hyndsight/backtransforming/
...
In my [previous post on transformations](http://robjhyndman.com/hyndsight/forecasting-within-limits/), I described the scaled logit transformation for bounding a forecast between specified limits $a$ and $b$. In this case,
