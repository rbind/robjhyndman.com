...
link: http://robjhyndman.com/hyndsight/forecast-intervals-for-aggregates/
...
I’ve previously posted [a trick using seasonal ARIMA models](http://robjhyndman.com/hyndsight/forecasting-annual-totals/) to do this. There is also Section 6.6 in my [2008 Springer book](http://www.exponentialsmoothing.net), deriving the analytical results for some ETS models.
