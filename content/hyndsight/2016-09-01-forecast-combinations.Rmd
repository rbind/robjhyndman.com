...
link: http://robjhyndman.com/hyndsight/forecast-combinations/
...
```{r opera2, message=FALSE, cache=TRUE}
library(opera)
...
```{r opera3, message=FALSE, cache=TRUE}
...
```{r forecastHybrid, message=FALSE, cache=TRUE}
