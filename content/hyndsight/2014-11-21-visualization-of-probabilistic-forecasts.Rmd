...
link: http://robjhyndman.com/hyndsight/visualization-of-probabilistic-forecasts/
...
The dark region has 50% coverage and the light region has 95% coverage. The forecast distributions become bimodal after the first ten iterations, and so the 50% region is split in two to show that. This graphic was taken from a [_J. Forecasting_ paper](http://robjhyndman.com/papers/highest-density-forecast-regions-for-non-linear-and-non-normal-time-series-models/) I wrote in 1996, so these ideas have been around for a while!
