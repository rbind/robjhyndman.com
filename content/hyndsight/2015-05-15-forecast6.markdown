...
I have added two new functions `taperedacf` and `taperedpacf` to implement the estimates and plots proposed in [this recent paper](http://robjhyndman.com/papers/mpcomments/).
