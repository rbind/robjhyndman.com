...
Another plot that has proved popular is to animate this rainbow plot by mapping year to animation time. With the new [`gganimate`](https://github.com/thomasp85/gganimate) package (still only on github), that is as easy as adding a few more lines to the end of the above code.
