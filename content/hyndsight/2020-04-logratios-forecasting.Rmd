...
This doesn't tell us anything about how the disaster is overwhelming the health systems of each country (the cumulative case graph at the top of this post is best for that), but it does tell us how well each country is managing to slow the rate of infection and reduce the slope of those curves. 
