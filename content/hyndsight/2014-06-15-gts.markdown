...
link: http://robjhyndman.com/hyndsight/gts/
slug: gts
...
With the latest version of the [hts package for R](http://robjhyndman.com/software/hts), it is now possible to specify rather complicated grouping structures relatively easily.
