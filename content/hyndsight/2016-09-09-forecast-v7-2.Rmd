...
mathjax: true
link: http://robjhyndman.com/hyndsight/forecast-v7-2/
slug: forecast-v7-2
...
As usual, there have been lots of bug fixes, mostly in functionality introduced in v7. More details are provided in the [Changelog](https://cran.r-project.org/web/packages/forecast/ChangeLog) or in the [github commits](https://github.com/robjhyndman/forecast/commits/master).
