...
link: http://robjhyndman.com/hyndsight/forecast8/
slug: forecast8
title: forecast 8.0
wordpress_id: 4029
categories:
...
The `tsCV` and `CVar` functions have been added. These were discussed in a [previous post](http://robjhyndman.com/hyndsight/tscv/).
...
The `baggedETS` function has been added, which implements the procedure discussed in [Bergmeir et al (2016)](http://robjhyndman.com/papers/bagging-ets/) for bagging ETS forecasts.
...
There is quite a bit more — see the [Changelog](https://github.com/robjhyndman/forecast/blob/master/ChangeLog) for a list.
