...
link: http://robjhyndman.com/hyndsight/thief/
slug: thief
...
I have a new R package available to do temporal hierarchical forecasting, based on [my paper with George Athanasopoulos, Nikolaos Kourentzes and Fotios Petropoulos](http://robjhyndman.com/working-papers/temporal-hierarchies/). (Guess the odd guy out there!)
