...
We have introduced the following functions: `gg_lag` and `ACF`. Explore the following time series using these functions. Can you spot any seasonality, cyclicity and trend? What do you learn about the series?
