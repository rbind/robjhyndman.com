...
Please bring your own laptop with a recent version of R and RStudio installed. We do hope to have the main packages available on CRAN before the course. In the meantime, the following code will install the relevant packages.
...
install.packages("feasts", repos = "tidyverts.org")
install.packages("fable", repos = "tidyverts.org")
```
